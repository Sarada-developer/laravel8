...
<div class="main-top">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="login-box">
                    @if(Session::has('register_users'))
                    <!-- <button>{{Session::get('register_users')['name']}}</button> -->
                    <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    {{Session::get('register_users')['name']}}
                    </button>
          ...
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
            ...
            <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal2">Log In</button>
                   </select>
                   @endif
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group col-md-6">
    ...
    <input type="text" class="form-control" name="phone_no" placeholder="Enter Your Phone Number" required>
  </div>
    <div class="form-group col-md-6">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="blog-box">
                        <div class="blog-img">
                            <img class="img-fluid" src="{{asset('assets/images/blog-img.jpg')}}" alt="" />
                        </div>
